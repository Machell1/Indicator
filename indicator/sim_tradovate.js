...
// window mirrors the wrapper's v13 default (Asian session 18->03 NY) so
// the wrapper-vs-direct-core signal comparison stays apples-to-apples
const ref = new DaleCore({ htfSessions: 20, nyStartHour: 18, nyEndHour: 3 });
